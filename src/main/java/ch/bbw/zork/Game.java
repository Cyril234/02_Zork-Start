...
[Waffenkammer(Uniform, Sprengstoff---[Gang]---[Kreuzung]---[Gang]---[Innenhof]---[Freiheit]
    ...
    public Game(Parser parser) {
        ...
        ConversationPiece wacheAusgangConversationPiece1_3 = new ConversationPiece("Die Wache rollt mit den Augen: „Na schön, geh schon, sonst krieg ich wieder Ärger.“", "Du zuckst mit den Schultern, als wüsstest du es selbst nicht genau.", ConversationAktion.END_NORMAL);
        ConversationPiece wacheAusgangConversationPiece1 = new ConversationPiece("Aussenposten? Davon hat mir keiner was gesagt. Wer hat dich eingeteilt?", wacheAusgangConversationPiece1_1, wacheAusgangConversationPiece1_2, wacheAusgangConversationPiece1_3, "Ich wurde zum Aussenposten geschickt. Muss schnell raus.");

        ConversationPiece wacheAusgangConversationPiece2_1 = new ConversationPiece("Die Wache schaut kurz und nickt: „Ah ja, die Werkleute wieder…“", "Werkzeug. Die Mechaniker draussen warten.", ConversationAktion.END_NORMAL);
        ConversationPiece wacheAusgangConversationPiece2_2 = new ConversationPiece("Die Wache tritt näher, will es sehen. Als sie näher kommt, merkt sie, dass du gar keinen Wärterausweis hast, und nimmt dich fest.", "Papiere vom Quartiermeister. Soll ich sie dir zeigen?", ConversationAktion.END_GAME);
        ConversationPiece wacheAusgangConversationPiece2_3 = new ConversationPiece("Die Wache lacht: „Na dann beeil dich, das Zeug wiegt sicher genug.“", "Du hältst dir den Rücken und tust so, als würdest du etwas Schweres tragen.", ConversationAktion.END_NORMAL);
        ConversationPiece wacheAusgangConversationPiece2 = new ConversationPiece("Etwas nach draussen bringen? Was denn?", wacheAusgangConversationPiece2_1, wacheAusgangConversationPiece2_2, wacheAusgangConversationPiece2_3, "Der Hauptmann hat mich beauftragt, etwas nach draussen zu bringen.");

        ConversationPiece wacheAusgangConversationPiece3_1 = new ConversationPiece("Die Wache lacht müde: „Na, das kann ich verstehen. Raus mit dir!“", "Schichtende! Ich will endlich Feierabend!", ConversationAktion.END_NORMAL);
        ConversationPiece wacheAusgangConversationPiece3_2 = new ConversationPiece("Die Wache nickt: „Pflichtbewusst, was? Na gut, geh schon.“", "Du bleibst stehen, salutierst knapp, sagst aber nichts.", ConversationAktion.END_NORMAL);
        ConversationPiece wacheAusgangConversationPiece3_3 = new ConversationPiece("Die Wache ruft laut: „He! Bleib sofort stehen!“ Sie greift zum Funkgerät und alarmiert die anderen. Du hast keine Chance mehr zu fliehen.", "Du tust so, als hättest du ihn nicht gehört, und gehst schneller.", ConversationAktion.END_GAME);
        ConversationPiece wacheAusgangConversationPiece3 = new ConversationPiece("He! Bleib stehen! Ich hab gesagt: Halt! Was machst du da?", wacheAusgangConversationPiece3_1, wacheAusgangConversationPiece3_2, wacheAusgangConversationPiece3_3, "Du hebst nur kurz die Hand zum Gruss und gehst weiter.");

        ConversationPiece wacheAusgangConversationPiece = new ConversationPiece("Halt! Stopp! Wohin des Weges?", wacheAusgangConversationPiece1, wacheAusgangConversationPiece2, wacheAusgangConversationPiece3);

        ConversationPiece prisonerEsssaalConversationPiece1_1 = new ConversationPiece("Der Häftling lehnt sich langsam zurück. Ein kurzes, anerkennendes Nicken.\nDann schiebt er seine Hand unter sein Tablett, löst etwas von der Unterseite und legt es vor dich:\nEs ist ein schmaler, verbogener Metalllöffel.\nEr sagt nichts dazu — er tut einfach so, als hätte es keine Bedeutung.", "Ich verstecke mich vor niemandem.", ConversationAktion.GIVE_ITEM, spoon);
        ConversationPiece prisonerEsssaalConversationPiece1_2 = new ConversationPiece("Der Häftling schnauft verächtlich.\n„Wenn du nicht einmal weisst, was du willst, bist du hier nur Ballast.“\nEr steht langsam auf und geht. Die anderen im Raum beachten dich nicht weiter. Du sitzt allein weiter.", "Vielleicht… spielt das eine Rolle?", ConversationAktion.END_NORMAL);
        ConversationPiece prisonerEsssaalConversationPiece1_3 = new ConversationPiece("Der Häftling packt blitzschnell deinen Kragen und zieht dich herunter.\nMit der freien Hand schlägt er dir kräftig gegen die Schläfe.\nDir wird schwarz vor Augen.\nDu kippst vom Stuhl, bewusstlos.", "Du stehst halb auf, zögerst und setzt dich wieder.", ConversationAktion.END_GAME);
        ConversationPiece prisonerEsssaalConversationPiece1 = new ConversationPiece("Platz gibt’s genug, Neuling. Du hast meinen gewählt. Klingt für mich nach einer schlechten Ausrede. Wovor läufst du weg?", prisonerEsssaalConversationPiece1_1, prisonerEsssaalConversationPiece1_2, prisonerEsssaalConversationPiece1_3, "Hier war Platz.");

        ConversationPiece prisonerEsssaalConversationPiece2_1 = new ConversationPiece("Der Häftling mustert dich erneut. Dann nickt er kurz — ein ungewöhnlich ruhiges, fast respektvolles Nicken.\nEr nimmt seinen Löffel, dreht ihn zwischen den Fingern und legt ihn kommentarlos zu dir.", "Ich habe dir nichts getan.", ConversationAktion.GIVE_ITEM, spoon);
        ConversationPiece prisonerEsssaalConversationPiece2_2 = new ConversationPiece("Der Häftling steht langsam auf. Ohne zu schreien oder zu drohen packt er dich an den Haaren und schlägt deinen Kopf hart gegen die Tischkante.\nEin dumpfer Schlag.\nAlles wird schwarz.", "Wenn du Stress willst, sag es einfach.", ConversationAktion.END_GAME);
        ConversationPiece prisonerEsssaalConversationPiece2_3 = new ConversationPiece("Der Häftling schaut kurz irritiert, dann verliert er das Interesse.\nEr setzt sich wieder ans Essen.\nKein Wort mehr.\nDu wirst komplett ignoriert.", "Du zuckst mit den Schultern.", ConversationAktion.END_NORMAL);
        ConversationPiece prisonerEsssaalConversationPiece2 = new ConversationPiece("Gesellschaft? Von mir? Du weisst gar nicht, mit wem du redest. Manche hätten dich jetzt schon am Kragen.", prisonerEsssaalConversationPiece2_1, prisonerEsssaalConversationPiece2_2, prisonerEsssaalConversationPiece2_3, "Ich dachte, du willst Gesellschaft.");

        ConversationPiece prisonerEsssaalConversationPiece3_1 = new ConversationPiece("Der Häftling wirkt zufrieden mit deiner stillen Antwort.\nEr greift in seine Tasche, zieht einen schmalen, leicht verbogenen Löffel heraus und legt ihn vor dich.\nKeine Erklärung.\nKeine Worte.", "Du nickst leicht.", ConversationAktion.GIVE_ITEM, spoon);
        ConversationPiece prisonerEsssaalConversationPiece3_2 = new ConversationPiece("Der Häftling zuckt die Schultern.\n„Dann bleib unsichtbar.“\nEr wendet sich wieder seinem Essen zu.\nEs passiert nichts.", "Ich halte mich aus allem raus.", ConversationAktion.END_NORMAL);
        ConversationPiece prisonerEsssaalConversationPiece3_3 = new ConversationPiece("Der Häftling steht plötzlich auf.\nEr tritt neben dich, packt deinen Hinterkopf und drückt ihn hart gegen die Tischplatte.\nDer Aufprall ist heftig.\nDu verlierst das Bewusstsein.", "Du schweigst weiter.", ConversationAktion.END_NORMAL);
        ConversationPiece prisonerEsssaalConversationPiece3 = new ConversationPiece("Der Häftling starrt dich lange an. Er legt die Stirn schief, als würde er dich analysieren.\n„Stille… Manchmal ist das Respekt. Manchmal Angst. Was ist es bei dir?“", prisonerEsssaalConversationPiece3_1, prisonerEsssaalConversationPiece3_2, prisonerEsssaalConversationPiece3_3, "Du schweigst.");

        ConversationPiece prisonerEsssaalConversationPiece = new ConversationPiece("Du setzt dich an einen Tisch. Der Häftling neben dir sagt: „Du setzt dich einfach hin wie jemand, der nicht weiss, wo er ist. Also sag schon: Warum sitzt du genau hier bei mir?“", prisonerEsssaalConversationPiece1, prisonerEsssaalConversationPiece2, prisonerEsssaalConversationPiece3);

        ConversationPiece wacheInnenhofConversationPiece1_1 = new ConversationPiece("„Du hast recht“, sagt die Wache. „Aber wenn ich herausfinde, dass du lügst, werde ich dich zerstören.“ Mit diesen letzten Worten rennt die Wache Richtung Zellblock 5.", "Wenn ich lügen würde, würdest du es eh herausfinden. Also wieso sollte ich lügen?", ConversationAktion.END_NORMAL);
        ConversationPiece wacheInnenhofConversationPiece1_2 = new ConversationPiece("Die Wache packt dich plötzlich am Kragen und hebt dich hoch. „Bob ist seit drei Tagen im Urlaub“, sagt sie und legt dir Handschellen an.", "Keine Ahnung, aber Bob hat mich geschickt.", ConversationAktion.END_GAME);
        ConversationPiece wacheInnenhofConversationPiece1_3 = new ConversationPiece("„Okay, du hast recht, aber bleib hier“, sagt die Wache und geht schnellen Schrittes Richtung Zellblock 5.", "„Habe ich dich jemals belogen?“, sagst du.", ConversationAktion.END_NORMAL);
        ConversationPiece wacheInnenhofConversationPiece1 = new ConversationPiece("„Wirklich?“, sagt die Wache misstrauisch. „Wieso sollte ich dir glauben?“", wacheInnenhofConversationPiece1_1, wacheInnenhofConversationPiece1_2, wacheInnenhofConversationPiece1_3, "„Eine andere Wache hat mich geschickt“, sagst du nervös. „Ich soll dich informieren, dass du dringend im Zellblock 5 gebraucht wirst!“");

        ConversationPiece wacheInnenhofConversationPiece2 = new ConversationPiece("Die Wache weicht deiner Faust aus und erwidert sie mit einem Schlag voll ins Gesicht. Um dich wird alles schwarz.", "Du holst aus und schlägst die Wache ins Gesicht, damit sie ohnmächtig wird.", ConversationAktion.END_GAME);

        ConversationPiece wacheInnenhofConversationPiece3_1 = new ConversationPiece("Die Wache wird misstrauisch und fragt dich, woher du weisst, dass dort jemand ohnmächtig ist. Als du keine Antwort hast, dreht sie sich um und sagt: „Ich hätte wissen müssen, dass du mich anlügst.“ Die Wache nimmt dich fest.", "Du sagst, dass du nicht in Zellblock 3 gehen kannst, weil dort eine gegnerische Gang ist.", ConversationAktion.END_GAME);
        ConversationPiece wacheInnenhofConversationPiece3_2 = new ConversationPiece("Die Wache zuckt mit den Schultern und ruft dir zu, dass du im Innenhof warten sollst.", "„Ich kann kein Blut sehen“, antwortest du.", ConversationAktion.END_NORMAL);
        ConversationPiece wacheInnenhofConversationPiece3_3 = new ConversationPiece("Die Wache ruft ein zweites Mal, aber als du dich immer noch nicht bewegst, rennt sie Richtung Zellblock 3 und murmelt etwas über „diese dummen, tauben Insassen“.", "Du tust so, als würdest du ihn nicht hören.", ConversationAktion.END_NORMAL);
        ConversationPiece wacheInnenhofConversationPiece3 = new ConversationPiece("Die Wache rennt sofort Richtung Zellblock 3. Als sie merkt, dass du nicht mitkommst, schaut sie dich fragend an: „Wieso kommst du nicht mit?“", wacheInnenhofConversationPiece3_1, wacheInnenhofConversationPiece3_2, wacheInnenhofConversationPiece3_3, "„Wache! Wache!“, rufst du laut. „Im Zellblock 3 ist ein Gefangener ohnmächtig umgefallen! Sie brauchen unbedingt deine Hilfe!“");

        ConversationPiece wacheInnenhofConversationPiece = new ConversationPiece("Du gehst langsam auf die Wache zu, die in der Ecke steht. Sie schaut dich misstrauisch an. (Das ist deine Gelegenheit, sie abzulenken, damit du ausbrechen kannst.)", wacheInnenhofConversationPiece1, wacheInnenhofConversationPiece2, wacheInnenhofConversationPiece3);

        ConversationPiece wacheWachraumConversationPiece1 = new ConversationPiece("Die Wache schaut dich verwirrt an und fängt dann an zu lächeln. „Das ist der schlechteste Ausbruchsversuch, den ich je gesehen habe.“ Dann steht sie auf, holt aus und schlägt dir voll ins Gesicht. Dir wird schwarz vor Augen.", "Mit der Hand, die du in deiner Tasche hast, tust du so, als hättest du eine Pistole. Du sagst: „Wenn du mich nicht sofort rauslässt, werde ich dich erschiessen!“", ConversationAktion.END_GAME);
        ConversationPiece wacheWachraumConversationPiece2 = new ConversationPiece("„Schon gut“, meint die Wache. „Aber jetzt geh raus“, fügt sie noch an.", "„Sorry, falscher Raum“, sagst du.", ConversationAktion.END_NORMAL);
        ConversationPiece wacheWachraumConversationPiece3 = new ConversationPiece("„Lass mich mal nachsehen“, sagt die Wache. „Ah, jetzt sehe ich: Du kommst erst in 253 Jahren raus. Also mach es dir gemütlich.“", "„Ich wollte fragen, wann ich freigelassen werde“, meinst du. „Meine Insassen-ID ist 193-908-296.“", ConversationAktion.END_NORMAL);
        ConversationPiece wacheWachraumConversationPiece = new ConversationPiece("„Was machst du im Wachraum?“, fragt dich die Wache verärgert.", wacheWachraumConversationPiece1, wacheWachraumConversationPiece2, wacheWachraumConversationPiece3);
        ...
        innenhof.setParameter(null, freiheit3, null, gangWestEast6, wacheInnenhofConversationPiece);
        esssaal.setParameter(gangWestEast6, null, null, gangNordSued2, prisonerEsssaalConversationPiece);
        ...
        wachraum.setParameter(gangWestEast5, null, null, null, wacheWachraumConversationPiece);
        ...
        checkpoint.setParameter(gangNordSued2, null, freiheit4, null, uniform, wacheAusgangConversationPiece);
